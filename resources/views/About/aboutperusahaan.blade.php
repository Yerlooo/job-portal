  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarText"
        ...
        <div class="collapse navbar-collapse" id="navbarText">
            ...
            <li class="nav-item">
                <a id="nav-link-beranda" class="nav-link active ms-4" aria-current="page" href="/" style="color: #082A3C;">Beranda</a>
            </li>
                <li class="nav-item">
                    <a class="nav-link active ms-4" aria-current="page" href="/aboutperusahaan" style="color: #146D9A;">About Us</a>
                </li>
                <li class="nav-item">
...
<!-- Akhir Footer -->
            ...
            <script>
                document.addEventListener("DOMContentLoaded", function() {
                    ...
                    var isLoggedIn = localStorage.getItem('isLoggedIn') === 'true'; // Ubah logika sesuai dengan cara Anda menyimpan status login

                    var navLink = document.getElementById("nav-link-beranda");
